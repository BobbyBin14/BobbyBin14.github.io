...
/* Peter's Comments
For extra features, besides the mute button that we've done in class, I chose the loop button for this specific assignment which is accumulated from my own experience on Youtube. Since this is primarily a music video with 3D visuals as a companion piece, for me when I'm listening to music, I always like to listen to a song over and over again until I find it cool or even get sick of it to move on to another song hence why the loop feature is really important for me in my daily usage of Youtube or any media streaming platforms in general. That is why I decided to go with this feature. */
/* Loop */
function loop(){
